...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        print(settings.FREE_DELIVERY_THRESHOLD)
...
class OrderLineItem(models.Model):
    ...
    item = models.ForeignKey(Item, null=False, blank=False,
                             on_delete=models.CASCADE)
    item_colour = models.CharField(max_length=12, null=True, blank=True)
    ...
    def __str__(self):
        return f'See {self.item.name} on order {self.order.order_number}'
